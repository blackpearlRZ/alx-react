...
describe('tests the courseReducer function', () => {
    it('tests default state', () => {
        ...
        expect(returnedState).toEqual(Map({}));
    });
    ...
    it('tests the SELECT_COURSE', () => {
        ...
        const initialState = Map(coursesNormalizer([
            { id: 1, name: "ES6", credit: 60, isSelected: false },
            { id: 2, name: "Webpack", credit: 20, isSelected: false },
            { id: 3, name: "React", credit: 40, isSelected: false }
        ]));
        ...
        expect(returnedState).toEqual(expectedState);
        expect(returnedState.getIn(['entities', 'courses', actionObject.index, 'isSelected'])).toEqual(true);
    });
    ...
    it('tests the UNSELECT_COURSE', () => {
        ...
        const returnedState = courseReducer(initialState, actionObject);
        expect(returnedState).toEqual(expectedState);
        expect(returnedState.getIn(['entities', 'courses', actionObject.index, 'isSelected'])).toEqual(false);
    });
});